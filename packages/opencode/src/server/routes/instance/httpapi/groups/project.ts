  ...
  .add(
    HttpApiGroup.make("project")
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with the local Synora harness.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the project currently active in the local Synora harness.",
          }),
        ),
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "project",
          description: "Instance project routes.",
        }),
      )
